...
export const themes: Record<string, Theme> = {
  light: {
    ...
    button: 'relative overflow-hidden group bg-blue-500 text-white hover:bg-blue-600 px-6 py-3 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl',
  ...
  nature: {
    ...
    button: 'relative overflow-hidden group bg-green-600 text-white hover:bg-green-700 px-6 py-3 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl',
    buttonRipple: 'absolute top-0 left-0 w-full h-full bg-white/20 transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left',
  ...
  sunset: {
    ...
    button: 'relative overflow-hidden group bg-[#FF5722] text-white hover:bg-[#F4511E] px-6 py-3 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl',
    buttonRipple: 'absolute top-0 left-0 w-full h-full bg-white/20 transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left',
